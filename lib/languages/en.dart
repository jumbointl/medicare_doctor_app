final Map<String, Map<String, String>> enKeys = {
  'en': {
    ...
    "failed_to_load_image": "Failed to load image: @error",
    "full_name": "%s %s",
    "item_index_name": "%s - %s",
    "or": "or",
    "Cancelled": "Cancelled",
    ...
    "card_refund_manual": "Card refund needs manual processing via Bancard",
    ...
    "refresh": "Refresh",
    "no_active_clinic": "No active clinic.",
    "network_error": "Network error.",
    "calling_token": "Calling token @token",
    "no_pending_calls": "No pending calls.",
    "call_next_patient": "Call next patient",
    "call_patient": "Call",
    "attend": "Attended",
    "only_confirmed_can_call": "Only Confirmed appointments can be called",
    "called_token": "Called @token",
    "recalled_token": "Re-called @token",
    "patient_attended_marked": "Marked as attended",
    "recall": "Recall",
    "patient_called": "Patient called",
    "patient_recalled": "Patient re-called",
    "patient_no_show_marked": "Marked as no-show",
    ...
    "tab_per_clinic": "Per clinic",
    "coming_soon": "Coming soon",
    "saved_successfully": "Saved successfully",
    "select_a_clinic": "Select a clinic",
    "clinic_active": "Clinic active",
    ...
    "before_minutes": "Before (minutes)",
    "1440_one_day": "1440 = 1 day",
    "no_availability_range": "No-availability period",
    "from": "From",
    "to": "To",
    "clear": "Clear",
